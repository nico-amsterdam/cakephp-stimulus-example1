...
export default class extends Controller {
  ...
  update(event) {
    ...
    if (source && source.id === 'contest-price1' && this.hasOut1Target) {
       this.out1Target.textContent = source.value;
    }
    if (source && source.id === 'contest-price2' && this.hasOut2Target) {
       this.out2Target.textContent = source.value;
    }
    if (source && source.id === 'contest-price3' && this.hasOut3Target) {
