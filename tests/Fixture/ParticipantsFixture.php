...
class ParticipantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'contest_key' => ['type' => 'index', 'columns' => ['contest_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'name' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'contest_key' => ['type' => 'foreign', 'columns' => ['contest_id'], 'references' => ['contests', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
